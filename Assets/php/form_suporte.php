...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        echo "<script>alert('Reclamação enviada com sucesso!'); window.location.href='/gamexchange/suporte.php';</script>"; //ARRUMAR IMEDIATAMENTE ANTES DE ENVIAR O PI PELAMOR DE DEUS!!!!!!!!!!!!!!!!!!!!!
