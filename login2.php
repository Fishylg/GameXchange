...
<body>
    <div class="login2-container">
        <div class="form-box">
            ...
            <button class="continuar" onclick="window.location.href='login3.php'">Continuar</button>
            <p class="login-text">Já tem uma conta? <a href="login1.html" class="Registrar">Entrar</a>
        </div>
    </div>
</body>
</html>